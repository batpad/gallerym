...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventWork'
        db.create_table('gallery_eventwork', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('changed', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gallery.Event'])),
            ('work', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gallery.ArtistWork'])),
            ('order', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('gallery', ['EventWork'])

        # Removing M2M table for field featured_work on 'Event'
        db.delete_table('gallery_event_featured_work')


        # Changing field 'ExhibitionWork.order'
        db.alter_column('gallery_exhibitionwork', 'order', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):
        # Deleting model 'EventWork'
        db.delete_table('gallery_eventwork')

        # Adding M2M table for field featured_work on 'Event'
        db.create_table('gallery_event_featured_work', (
        ...
        db.create_unique('gallery_event_featured_work', ['event_id', 'artistwork_id'])


        # Changing field 'ExhibitionWork.order'
        db.alter_column('gallery_exhibitionwork', 'order', self.gf('django.db.models.fields.PositiveIntegerField')())
