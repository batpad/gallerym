...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exhibition.pdf'
        db.add_column('gallery_exhibition', 'pdf',
                      self.gf('filebrowser.fields.FileBrowseField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Exhibition.press_release'
        db.add_column('gallery_exhibition', 'press_release',
                      self.gf('filebrowser.fields.FileBrowseField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exhibition.pdf'
        db.delete_column('gallery_exhibition', 'pdf')

        # Deleting field 'Exhibition.press_release'
        db.delete_column('gallery_exhibition', 'press_release')
