...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exhibition.preview_date'
        db.add_column('gallery_exhibition', 'preview_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Exhibition.preview_start_time'
        db.add_column('gallery_exhibition', 'preview_start_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Exhibition.preview_end_time'
        db.add_column('gallery_exhibition', 'preview_end_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Exhibition.curated_by'
        db.add_column('gallery_exhibition', 'curated_by',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'Publication.featured'
        db.add_column('gallery_publication', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exhibition.preview_date'
        db.delete_column('gallery_exhibition', 'preview_date')

        # Deleting field 'Exhibition.preview_start_time'
        db.delete_column('gallery_exhibition', 'preview_start_time')

        # Deleting field 'Exhibition.preview_end_time'
        db.delete_column('gallery_exhibition', 'preview_end_time')

        # Deleting field 'Exhibition.curated_by'
        db.delete_column('gallery_exhibition', 'curated_by')

        # Deleting field 'Publication.featured'
        db.delete_column('gallery_publication', 'featured')
