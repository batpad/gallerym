...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventPressRelease.old_id'
        db.add_column('gallery_eventpressrelease', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Artist.old_id'
        db.add_column('gallery_artist', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EventReview.old_id'
        db.add_column('gallery_eventreview', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExhibitionReview.old_id'
        db.add_column('gallery_exhibitionreview', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ArtistReview.old_id'
        db.add_column('gallery_artistreview', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.old_id'
        db.add_column('gallery_event', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Exhibition.old_id'
        db.add_column('gallery_exhibition', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.old_id'
        db.add_column('gallery_publication', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ArtistPressRelease.old_id'
        db.add_column('gallery_artistpressrelease', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExhibitionPressRelease.old_id'
        db.add_column('gallery_exhibitionpressrelease', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ArtistWork.old_id'
        db.add_column('gallery_artistwork', 'old_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventPressRelease.old_id'
        db.delete_column('gallery_eventpressrelease', 'old_id')

        # Deleting field 'Artist.old_id'
        db.delete_column('gallery_artist', 'old_id')

        # Deleting field 'EventReview.old_id'
        db.delete_column('gallery_eventreview', 'old_id')

        # Deleting field 'ExhibitionReview.old_id'
        db.delete_column('gallery_exhibitionreview', 'old_id')

        # Deleting field 'ArtistReview.old_id'
        db.delete_column('gallery_artistreview', 'old_id')

        # Deleting field 'Event.old_id'
        db.delete_column('gallery_event', 'old_id')

        # Deleting field 'Exhibition.old_id'
        db.delete_column('gallery_exhibition', 'old_id')

        # Deleting field 'Publication.old_id'
        db.delete_column('gallery_publication', 'old_id')

        # Deleting field 'ArtistPressRelease.old_id'
        db.delete_column('gallery_artistpressrelease', 'old_id')

        # Deleting field 'ExhibitionPressRelease.old_id'
        db.delete_column('gallery_exhibitionpressrelease', 'old_id')

        # Deleting field 'ArtistWork.old_id'
        db.delete_column('gallery_artistwork', 'old_id')
