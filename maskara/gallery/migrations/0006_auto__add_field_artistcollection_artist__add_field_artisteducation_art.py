...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArtistCollection.artist'
        db.add_column('gallery_artistcollection', 'artist',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['gallery.Artist']),
                      keep_default=False)

        # Adding field 'ArtistEducation.artist'
        db.add_column('gallery_artisteducation', 'artist',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['gallery.Artist']),
                      keep_default=False)

        # Adding field 'ArtistNews.artist'
        db.add_column('gallery_artistnews', 'artist',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['gallery.Artist']),
                      keep_default=False)

        # Adding field 'ArtistSoloExhib.artist'
        db.add_column('gallery_artistsoloexhib', 'artist',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['gallery.Artist']),
                      keep_default=False)

        # Adding field 'ArtistPress.artist'
        db.add_column('gallery_artistpress', 'artist',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['gallery.Artist']),
                      keep_default=False)

        # Adding field 'ArtistAward.artist'
        db.add_column('gallery_artistaward', 'artist',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['gallery.Artist']),
                      keep_default=False)

        # Adding field 'ArtistGroupExhib.artist'
        db.add_column('gallery_artistgroupexhib', 'artist',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['gallery.Artist']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArtistCollection.artist'
        db.delete_column('gallery_artistcollection', 'artist_id')

        # Deleting field 'ArtistEducation.artist'
        db.delete_column('gallery_artisteducation', 'artist_id')

        # Deleting field 'ArtistNews.artist'
        db.delete_column('gallery_artistnews', 'artist_id')

        # Deleting field 'ArtistSoloExhib.artist'
        db.delete_column('gallery_artistsoloexhib', 'artist_id')

        # Deleting field 'ArtistPress.artist'
        db.delete_column('gallery_artistpress', 'artist_id')

        # Deleting field 'ArtistAward.artist'
        db.delete_column('gallery_artistaward', 'artist_id')

        # Deleting field 'ArtistGroupExhib.artist'
        db.delete_column('gallery_artistgroupexhib', 'artist_id')
