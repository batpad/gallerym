...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('gallery_artist', 'slug', self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=50))

        # Changing field 'Exhibition.slug'
        db.alter_column('gallery_exhibition', 'slug', self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=50))

        # Changing field 'Event.slug'
        db.alter_column('gallery_event', 'slug', self.gf('django.db.models.fields.SlugField')(default='', unique=True, max_length=50))

    def backwards(self, orm):

        # Changing field 'Artist.slug'
        db.alter_column('gallery_artist', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, null=True))

        # Changing field 'Exhibition.slug'
        db.alter_column('gallery_exhibition', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, null=True))

        # Changing field 'Event.slug'
        db.alter_column('gallery_event', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, null=True))
