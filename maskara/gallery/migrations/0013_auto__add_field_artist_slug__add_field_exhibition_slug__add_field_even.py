...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('gallery_artist', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Exhibition.slug'
        db.add_column('gallery_exhibition', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True),
                      keep_default=False)

        # Adding field 'Event.slug'
        db.add_column('gallery_event', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('gallery_artist', 'slug')

        # Deleting field 'Exhibition.slug'
        db.delete_column('gallery_exhibition', 'slug')

        # Deleting field 'Event.slug'
        db.delete_column('gallery_event', 'slug')
