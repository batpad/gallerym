...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExhibitionWork'
        db.create_table('gallery_exhibitionwork', (
        ...
        db.send_create_signal('gallery', ['ExhibitionWork'])
    ...
    def backwards(self, orm):
        # Deleting model 'ExhibitionWork'
        db.delete_table('gallery_exhibitionwork')
