...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exhibition.one_liner'
        db.add_column('gallery_exhibition', 'one_liner',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'Exhibition.location'
        db.add_column('gallery_exhibition', 'location',
                      self.gf('django.db.models.fields.CharField')(default='Gallery Maskara', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exhibition.one_liner'
        db.delete_column('gallery_exhibition', 'one_liner')

        # Deleting field 'Exhibition.location'
        db.delete_column('gallery_exhibition', 'location')
