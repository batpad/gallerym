...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FrontPageItem.blurb'
        db.add_column('gallery_frontpageitem', 'blurb',
                      self.gf('django.db.models.fields.CharField')(default='Current Exhibition', max_length=512, blank=True),
                      keep_default=False)

        # Adding field 'Event.end_date'
        db.add_column('gallery_event', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FrontPageItem.blurb'
        db.delete_column('gallery_frontpageitem', 'blurb')

        # Deleting field 'Event.end_date'
        db.delete_column('gallery_event', 'end_date')
