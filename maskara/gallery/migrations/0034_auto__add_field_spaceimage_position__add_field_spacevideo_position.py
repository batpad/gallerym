...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpaceImage.position'
        db.add_column('gallery_spaceimage', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'SpaceVideo.position'
        db.add_column('gallery_spacevideo', 'position',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpaceImage.position'
        db.delete_column('gallery_spaceimage', 'position')

        # Deleting field 'SpaceVideo.position'
        db.delete_column('gallery_spacevideo', 'position')
