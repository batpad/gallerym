...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArtistWork.is_available'
        db.add_column('gallery_artistwork', 'is_available',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArtistWork.is_available'
        db.delete_column('gallery_artistwork', 'is_available')
