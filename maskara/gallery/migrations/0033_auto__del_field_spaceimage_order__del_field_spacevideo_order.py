...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SpaceImage.order'
        db.delete_column('gallery_spaceimage', 'order')

        # Deleting field 'SpaceVideo.order'
        db.delete_column('gallery_spacevideo', 'order')


    def backwards(self, orm):
        # Adding field 'SpaceImage.order'
        db.add_column('gallery_spaceimage', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'SpaceVideo.order'
        db.add_column('gallery_spacevideo', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)
