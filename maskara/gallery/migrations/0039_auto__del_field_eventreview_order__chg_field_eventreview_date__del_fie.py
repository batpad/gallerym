...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EventReview.order'
        db.delete_column('gallery_eventreview', 'order')


        # Changing field 'EventReview.date'
        db.alter_column('gallery_eventreview', 'date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 9, 30, 0, 0)))
        # Deleting field 'ExhibitionReview.order'
        db.delete_column('gallery_exhibitionreview', 'order')


        # Changing field 'ExhibitionReview.date'
        db.alter_column('gallery_exhibitionreview', 'date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 9, 30, 0, 0)))
        # Deleting field 'ArtistReview.order'
        db.delete_column('gallery_artistreview', 'order')


        # Changing field 'ArtistReview.date'
        db.alter_column('gallery_artistreview', 'date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 9, 30, 0, 0)))

    def backwards(self, orm):
        # Adding field 'EventReview.order'
        db.add_column('gallery_eventreview', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


        # Changing field 'EventReview.date'
        db.alter_column('gallery_eventreview', 'date', self.gf('django.db.models.fields.DateField')(null=True))
        # Adding field 'ExhibitionReview.order'
        db.add_column('gallery_exhibitionreview', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


        # Changing field 'ExhibitionReview.date'
        db.alter_column('gallery_exhibitionreview', 'date', self.gf('django.db.models.fields.DateField')(null=True))
        # Adding field 'ArtistReview.order'
        db.add_column('gallery_artistreview', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


        # Changing field 'ArtistReview.date'
        db.alter_column('gallery_artistreview', 'date', self.gf('django.db.models.fields.DateField')(null=True))
