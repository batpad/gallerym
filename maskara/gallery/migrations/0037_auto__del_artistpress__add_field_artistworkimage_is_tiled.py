...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ArtistWorkImage.is_tiled'
        db.add_column('gallery_artistworkimage', 'is_tiled',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ArtistWorkImage.is_tiled'
        db.delete_column('gallery_artistworkimage', 'is_tiled')
