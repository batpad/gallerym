...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArtistWorkImage.image'
        db.alter_column('gallery_artistworkimage', 'image', self.gf('filebrowser.fields.FileBrowseField')(max_length=512, null=True))

    def backwards(self, orm):

        # Changing field 'ArtistWorkImage.image'
        db.alter_column('gallery_artistworkimage', 'image', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100))
