...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('gallery_frontpageitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('changed', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('position', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gallery.Event'], null=True, blank=True)),
            ('exhibition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gallery.Exhibition'], null=True, blank=True)),
        ))
        db.send_create_signal('gallery', ['FrontPageItem'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('gallery_frontpageitem')
