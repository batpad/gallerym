...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.press_release'
        db.add_column('gallery_event', 'press_release',
                      self.gf('filebrowser.fields.FileBrowseField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Publication.description'
        db.add_column('gallery_publication', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.press_release'
        db.delete_column('gallery_event', 'press_release')

        # Deleting field 'Publication.description'
        db.delete_column('gallery_publication', 'description')
