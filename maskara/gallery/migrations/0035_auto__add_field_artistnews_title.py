...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArtistNews.title'
        db.add_column('gallery_artistnews', 'title',
                      self.gf('django.db.models.fields.CharField')(default='edit me', max_length=512),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArtistNews.title'
        db.delete_column('gallery_artistnews', 'title')
