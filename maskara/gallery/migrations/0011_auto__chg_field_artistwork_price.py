...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArtistWork.price'
        db.alter_column('gallery_artistwork', 'price', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'ArtistWork.price'
        db.alter_column('gallery_artistwork', 'price', self.gf('django.db.models.fields.CharField')(default=10, max_length=128))
