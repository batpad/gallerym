...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('gallery_video', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Video.duration'
        db.add_column('gallery_video', 'duration',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('gallery_video', 'description')

        # Deleting field 'Video.duration'
        db.delete_column('gallery_video', 'duration')
