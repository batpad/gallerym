...
urlpatterns += patterns('maskara.gallery.views',
    ...
    url(r'^artists$', 'artists', {'represented': True}, name='artists'),
    url(r'^artists/all$', 'artists', {'represented': False }, name='represented_artists'),
    url(r'^(?P<object_type>[\w]+)/(?P<slug>[\w\-]+)/works/(?P<work_id>[0-9]*)$', 'work', name='work'),
    url(r'^(?P<object_type>[\w]+)/(?P<slug>[\w\-]+)/works/(?P<work_id>[0-9]*)/videos$', 'work_videos', name='work_video'),
    ...
    url(r'^publication/(?P<id>[0-9]*)', 'publication', name='publication'),
    url(r'^about/publications$', 'about_publications', name='about_publications'),
    url(r'^about$', 'about', name='about'),
    url(r'^about/mission$', 'about_mission', name='about_mission'),
    url(r'^about/people$', 'about_people', name='about_people'),
    url(r'^about/press$', 'about_press', name='about_press'),    
    url(r'^about/people/(?P<id>[0-9]*)$', 'about_person', name='about_person'),
    url(r'^about/space$', 'about_space', name='about_space'),
